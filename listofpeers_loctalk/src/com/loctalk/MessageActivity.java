...
//import com.loctalk.MessageActivity.IncomingHandler;
...
public class MessageActivity extends BaseActivity {
	...
	String broad = "192.168.0.255" ;			//broadcast IP
	static int counter =0;						//used as by getID(), which returns the message ID(PK)
	sender sen;									// Sender thread object
	TextView textv;							
  ...
  public MessageActivity(){
	...
	protected void onStart() {
		 ...
		 * (for e.g. peerActivty), it carries out the task of adding the messages that were received when
